 ...
 */
public class fragment_myapps_upgrade extends Fragment {
    DbHelper dbHelper;
    TextView tvErrorMsg;
    AppPrefs appPrefs;
    Common common;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        MainActivity.tv_main_second.setText(R.string.toolbar_upgrade);
    ...
    public void CallMYFetchAppDetailsApi(String UID) {
        ...
        callMYAppDetailsAPIRequest.post("http://fadootutorial.com/appgenerator/upgradeappslist.php", RequestFetchAppDetailsParams(UID), new FETCH_All_APP_DETAILS_result());
    }
    ...
    public class CardAdapter extends RecyclerView.Adapter<CardAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.imgnotification.setImageResource(R.drawable.upgrade_plan);
