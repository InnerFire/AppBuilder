...
package com.letsappbuilder.LibraryClass;
...
public class FabOptions extends FrameLayout implements View.OnClickListener {
    ...
    public void inflateButtonsFromAttrs(Context context, AttributeSet attrs) {
    ...
    public void addButtonsFromMenu(Context context, Menu menu) {
    ...
    public void addButton(Context context, MenuItem menuItem) {
